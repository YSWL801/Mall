<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebManager.Pages.Employee.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var list = {
            ...
            displayList: function (result) {
                $('#categoryList tbody').empty('#categoryList tbody'); 
    ...
    <script type="text/x-jquery-tmpl" id="tmpl">
        <tr>
            ...
            <td>${ModifiedTime}</td>
            <td>
                <a class="btn btn-primary btn-xs" href="/Pages/Employee/Edit.aspx?id={{= Id}}">修改</a>
